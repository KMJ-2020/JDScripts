...
const inviteCodes = [
  `ZE9iO4vyJ4J0ljGUsCw@eU9Ya7q2N_Qn9m7QwyAR0A@eU9Yab67ZK9w-W_Sn3ZBgw`,
  `ZE9iO4vyJ4J0ljGUsCw@eU9Ya7q2N_Qn9m7QwyAR0A@eU9Yab67ZK9w-W_Sn3ZBgw`
]
if ($.isNode()) {
...
function getAuthorShareCode(url = "https://raw.githubusercontent.com/KMJ-2020/QuantumultX/main/Scripts/jd_updateCash.json") {
  return new Promise(resolve => {
    $.get({url, headers:{
      ...
      $.authorCode = [`ZE9iO4vyJ4J0ljGUsCw@eU9Ya7q2N_Qn9m7QwyAR0A@eU9Yab67ZK9w-W_Sn3ZBgw`];
      try {
        if (err) {
        } else {
...
function getAuthorShareCode2(url = "https://raw.githubusercontent.com/KMJ-2020/QuantumultX/main/Scripts/jd_updateCash.json") {
  return new Promise(resolve => {
    $.get({url, headers:{
      ...
      $.authorCode2 = [`ZE9iO4vyJ4J0ljGUsCw@eU9Ya7q2N_Qn9m7QwyAR0A@eU9Yab67ZK9w-W_Sn3ZBgw`];
      try {
        if (err) {
        } else {
