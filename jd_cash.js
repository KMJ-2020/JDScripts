...
const inviteCodes = [
  `eU9Yab67ZK9w-W_Sn3ZBgw@eU9Yab3nNf4n9zrdnXNCgw@eU9YaeW2Y6km-GrczHtH1g`,
  `eU9Yab67ZK9w-W_Sn3ZBgw@eU9Yab3nNf4n9zrdnXNCgw@eU9YaeW2Y6km-GrczHtH1g`
]
if ($.isNode()) {
...
function getAuthorShareCode(url = "https://raw.githubusercontent.com/KMJ-2020/QuantumultX/main/Scripts/jd_updateCash.json") {
  return new Promise(resolve => {
    $.get({url, headers:{
        "User-Agent": "Mozilla/5.0 (iPhone; CPU iPhone OS 13_2_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0.3 Mobile/15E148 Safari/604.1 Edg/87.0.4280.88"
      }, timeout: 200000,}, async (err, resp, data) => {
      $.authorCode = [`eU9Yab67ZK9w-W_Sn3ZBgw@eU9Yab3nNf4n9zrdnXNCgw@eU9YaeW2Y6km-GrczHtH1g`];
      try {
        if (err) {
        } else {
...
function getAuthorShareCode2(url = "https://raw.githubusercontent.com/KMJ-2020/QuantumultX/main/Scripts/jd_updateCash.json") {
  return new Promise(resolve => {
    $.get({url, headers:{
        "User-Agent": "Mozilla/5.0 (iPhone; CPU iPhone OS 13_2_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0.3 Mobile/15E148 Safari/604.1 Edg/87.0.4280.88"
      }, timeout: 200000,}, async (err, resp, data) => {
      $.authorCode2 = [`eU9Yab67ZK9w-W_Sn3ZBgw@eU9Yab3nNf4n9zrdnXNCgw@eU9YaeW2Y6km-GrczHtH1g`];
      try {
        if (err) {
        } else {
